...
1. **Horizontally**, the ball keeps moving at a constant speed $u$ (no force pushes or pulls it sideways)
2. **Vertically**, gravity pulls the ball downward with constant acceleration $g \approx 9.8\;\text{m/s}^2$
